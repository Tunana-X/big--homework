	 ...
	 <div id="product_info">
			<div>
				 <table class="ptable ptable2" style="margin-bottom:5px;">
					<tr class="head_text">
					     <td width="110" align="center">订单编号</td>
					     <td width="65" align="center">订单日期</td>
					     <td width="" align="center">收件人信息</td>
					     <td width="65" align="center">订单总额</td>
					     <td width="65" align="center">会员折扣</td>
					     <td width="65" align="center">实付金额</td>
					     <td width="65" align="center">当前状态</td>
					...
					<c:if test="${orderss!=null && fn:length(orderss)>0}">
					   ...
					   <tr> 
					     ...
					     <td width="" align="left" style="padding-left:5px;">
					     	收件人：${orders.real_name}
					     	<br/>电话：${orders.user_phone}
					     	<br/>地址：${orders.user_address}
					     </td>
