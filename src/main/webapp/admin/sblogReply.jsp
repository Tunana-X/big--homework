...
<body>
<div class="pageTitle">
	<span id="MainTitle"><span style="color:gray">留言信息管理&nbsp;&nbsp;/&nbsp;&nbsp;</span>回复留言信息</span>
</div>
...
<table width="800" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px;margin-bottom:10px;">
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
          ...
          <td>
          	<c:if test="${sblog.replys!=null &&  fn:length(sblog.replys)>0}">
   	 		<c:forEach items="${sblog.replys}" var="sblogReply" varStatus="status">
   	 		    <span style="color:#000">${sblogReply.user_id==0?'管理员':sblogReply.user_name}</span> 回复：
        ...
        <tr>
          <td align="right" style="padding-right:5px"><font color="#000">*</font> 回复内容：</td>
          <td>
