...
<body>
<div class="pageTitle">
	<span id="MainTitle"><span style="color:gray">商品留言管理&nbsp;&nbsp;/&nbsp;&nbsp;</span>商品留言查询</span>
</div>
  ...
  <tr>
    <td colspan="2" align="center">
      ...
      <input type="text" id="goods_name" name="goods_name" 
      		value="${paramsSblog.goods_name}" class="inputstyle" style="width:150px;"/>&nbsp;
            留言用户：
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">${sblog.goods_name}</td>
     ...
     <td width="" align="center">
     	<input type="button" value="回复"  onclick="window.location.href='Admin_replySblog.action?sblog_id=${sblog.sblog_id}'" class="btnstyle"/>
     </td>
   </tr> 
   </c:forEach>
   </c:if>
