...
<body>
<div class="pageTitle">
	<span id="MainTitle"><span style="color:gray">商品信息管理&nbsp;&nbsp;/&nbsp;&nbsp;</span>${goods!=null && goods.goods_id!=0 ?'编辑':'添加'}商品信息</span>
</div>
...
<table width="800" align="center" cellpadding="0" cellspacing="0" style="margin-top:10px;margin-bottom:10px;">
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        <tr>
          <td width="150" align="right" style="padding-right:5px"><font color="#000">*</font> 商品名称：</td>
          <td width="*">
          	<input type="text" name="goods_name" id="goods_name" value="${goods.goods_name}" style="width:300px"/>
          </td>
        </tr> 
        <tr>
          <td align="right" style="padding-right:5px"><font color="#000">*</font> 商品类别：</td>
          <td>
          	 <select id="goods_type_id" name="goods_type_id" class="selectstyle"  style="width:300px">
        ...
        <tr>
	     ...
	     <tr>
	      ...
	      <td align="left" height="80">
	          <iframe name="uploadPage" src="uploadImg1.jsp" width="100%" height="80" marginheight="0" marginwidth="0" scrolling="no" frameborder="0"></iframe>            
	       </td>
	    </tr>
        <tr>
          <td align="right" style="padding-right:5px"><font color="#000">*</font> 商品原价：</td>
          <td >
          	<input type="text" name="goods_price1" id="goods_price1" value="${goods.goods_price1}" style="width:300px"/>
          </td>
        </tr> 
        <tr>
          <td align="right" style="padding-right:5px"><font color="#000">*</font> 当前价格：</td>
          <td >
          	<input type="text" name="goods_price2" id="goods_price2" value="${goods.goods_price2}" style="width:300px"/>
          </td>
        </tr> 
        <tr>
          <td width="35%" align="right" style="padding-right:5px"><font color="#000">*</font> 库存数量：</td>
          <td width="65%">
          	<input type="text" name="goods_count" id="goods_count" value="${goods.goods_count}" style="width:300px"/>
          </td>
        </tr> 
        <tr>
          <td align="right" style="padding-right:5px"><font color="#000">*</font>商品介绍：</td>
          <td >
