...
<body>
<div class="pageTitle">
	<span id="MainTitle"><span style="color:gray">商品分类管理&nbsp;&nbsp;/&nbsp;&nbsp;</span>商品分类查询</span>
</div>
...
<table width="95%" align="center" class="table_top" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center">
            类型名称：
      <input type="text" id="goods_type_name" name="goods_type_name" value="${paramsGoodsType.goods_type_name}" class="inputstyle" style="width:300px"/>&nbsp;
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
     	<input type="button" value="编辑"  onclick="window.location.href='Admin_editGoodsType.action?goods_type_id=${goodsType.goods_type_id}'" class="btnstyle"/>
     </td>
   </tr> 
   </c:forEach>
   </c:if>
   <c:if test="${goodsTypes==null ||  fn:length(goodsTypes)==0}">
   <tr>
     <td height="60" colspan="10" align="center"><b>&lt;不存在商品分类信息&gt;</b></td>
   </tr>
   </c:if>
