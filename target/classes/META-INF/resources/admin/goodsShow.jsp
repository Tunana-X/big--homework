...
<body>
<div class="pageTitle">
	<span id="MainTitle"><span style="color:gray">商品管理&nbsp;&nbsp;/&nbsp;&nbsp;</span>商品查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
     	<input type="button" value="查看"  onclick="window.location.href='Admin_queryGoods.action?goods_id=${goods.goods_id}'" class="btngreen"/>
     	<input type="button" value="编辑"  onclick="window.location.href='Admin_editGoods.action?goods_id=${goods.goods_id}'" class="btnstyle"/>
     </td>
   </tr> 
   </c:forEach>
   </c:if>
