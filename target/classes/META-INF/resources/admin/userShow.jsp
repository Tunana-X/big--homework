...
<body>
<div class="pageTitle">
	<span id="MainTitle"><span style="color:gray">用户管理&nbsp;&nbsp;/&nbsp;&nbsp;</span>用户查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="list0" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
     	<input type="button" value="编辑"  onclick="window.location.href='Admin_editUser.action?user_id=${user.user_id}'" class="btnstyle"/>
     </td>
   </tr> 
   </c:forEach>
   </c:if>
   <c:if test="${users==null || fn:length(users)==0}">
   <tr>
     <td height="60" colspan="14" align="center"><b>&lt;不存在会员信息&gt;</b></td>
   </tr>
   </c:if>
